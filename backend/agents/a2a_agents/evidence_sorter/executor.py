"""Evidence Sorter Agent Executor"""
import sys
import os
...
class EvidenceSorterExecutor(BaseAgentExecutor):
    """Executor for Evidence Sorter Agent"""
    
    def __init__(self):
        super().__init__('EvidenceSorterAgent')
        self.agent = EvidenceSorterAgent()
