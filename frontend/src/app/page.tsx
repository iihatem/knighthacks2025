  ...
  return (
    <Dashboard>
      <div className="space-y-6">
        ...
        <div className="flex items-center">
          <span className="text-2xl font-bold text-orange-600 mr-2">+20%</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center p-3 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">Contract Law Case</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mt-1">Copyright Dispute</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center p-3 bg-gray-50 rounded-xl">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-gray-800">Randy Gouse</span>
